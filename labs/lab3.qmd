...
Diagnose the statistical properties for the sample mean for this variable (making a figure of the sampling distribution and/or a table of bias and mse, whatever feels more useful).


**Questions:**

- *How does the statistcal properties compare to the mean of `vote`? Explain*
- *What would be the ideal sample size to ensure the sample mean for the new variablehas good statistical properties? Show at least three options and explain. You will commit to this sample size for the remainder of the lab*
...
[CONTINUE HERE COMPARE]

# Your own estimator

[This may be too much unless you give them a list]