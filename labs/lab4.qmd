...
A more eclectic scholar may propose conciliatory argument: The "effect" of `water` as a disease-preventing factor depends on other state-capacity factors captured by `elec`. After all, if you have access to clean drinking water *and* electricity, that means that you can cook nicer meals, keep food and antibiotics in the fridge, and perhaps other more substantial factors that escape the expertise of an instructor of a probability and statistics course.
