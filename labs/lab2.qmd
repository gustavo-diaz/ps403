...
```{r}
# Change the value of set.seed so that results are unique to you
set.seed(1)
data = data.frame(
...
- Does the **theoretical** version of this quantity have a name (e.g. expected value, variance)? 
- Does the **empirical** version of this quantity have a name?
...
1. It may help your understanding to rewrite these formula with pen and paper

2. Some of these may be repeats, but they are calculated in a different way to illustrate some useful statistical property. If applicable, explain what makes an alternative presentation of a quantity interesting, useful, or important

3. The AM textbook only mentions them in a footnote. But some of the quantities below may be [standardized moments](https://en.wikipedia.org/wiki/Standardized_moment)
:::
...
You will get closer to a "satisfactory" mark if you:
