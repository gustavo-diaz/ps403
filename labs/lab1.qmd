...
## Which types of packaging hve an equal distribution of colors?
...
::: {.callout-tip}
## Tips
1. We need to assume something about the distribution of birthdays. The AM book introduced two useful distributions that correspond to functions in R. Which distribution seems more useful to approach this problem? Why?
