---
title: "Lab 6: Adjusting for covariates"
author: 
  - FirstName LastName
...
For this lab, we will follow the application in Section 4.4 in the AM textbook.
...
This is the January 2025 version of the indicators, the AM book uses an older version, so our results will differ.

This data set has `r nrow(qog)` observations (countries) and `r ncol(qog)` variables. This is too many variables to carry along, so we will focus on three only.
...
Think about the distinction of total vs. direct effect in [Achen (2005)](https://doi.org/10.1080/07388940500339167) and the idea of "holding constant" in some of the assigned readings for this week.
