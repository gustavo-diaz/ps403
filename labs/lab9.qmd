...
One of the perils of conditioning on propensity scores is the problem of **overlap**. We should compare the distribution of propensity scores between groups (make the plot look prettier if you can).
