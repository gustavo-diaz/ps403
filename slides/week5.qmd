...
::: aside
You can also interpret it as the interval containing all the hypotheses we cannot reject at $\alpha = 0.05$. This interpretation sees CIs as **inverted hypothesis tests** (more in the lab)
:::
