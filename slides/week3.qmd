...
Averages (and average-like things) have nice **properties** that facilitate statistical inference

. . .

Meaning they *usually* produce single number summaries that are *reliable* or *useful*

. . .

**Next week:** Statistical properties

**This week:** Mathematical properties
...
4. $E[X_1 + \ldots + X_p] = E[X_1] + \ldots + E[X_p]$
...
4. EWSSWE: $E[X_1 + \ldots + X_p] = E[X_1] + \ldots + E[X_p]$
...
They are "central" because they convey spread *centered in the expected value*
...
[The first central moment is zero by definition, but the second central moment is variance]
