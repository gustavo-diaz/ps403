...
lm(Y ~ Treated * Post-treatment, data = dat) # both are the same
...
Know as the two-way fixed-effects estimator (TWFE)
...
## Thank you! {.center background-color="#D2D755"}

&nbsp;

![](fig/panda_dance.gif){fig-align="center" width="10%" height="10%"} 
:::