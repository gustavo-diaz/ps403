...
- We are not relyng on i.i.d. sampling to connect $\theta$ and $\widehat \theta$
...
::: aside
**Lab:** MLE will often give the same answers as a non-parametric estimator because the asymptotic properties are the same
:::
...
You can conduct inference via likelihood-ratio tests between parameters of interest
