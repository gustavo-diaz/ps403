...
- Useful since you cannot *nonparametrically* condition on many covariates

- Can estimate consistently via ML (usually logit)

- Still suffers from *omitted variable bias*
:::
...
- Combining the two in a model that yield consistent estimates when *either* is correct
:::
