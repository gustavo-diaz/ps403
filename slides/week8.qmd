...
- Normal approximation based tests also work with large enough samples
...
t.test(y ~ x, data = dat) # Gives normal approximation p-value
```
...
::: incremental
- $D_i = \{0,1\}$ condtion (0: control, 1: treatment)
