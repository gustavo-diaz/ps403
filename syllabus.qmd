...
<!-- Artur Baranov (<artur.baranov@u.northwestern.edu>) -->
**GitHub Repository:** <https://github.com/gustavo-diaz/ps403>  
**Canvas:** TBD

<!-- <https://canvas.northwestern.edu/courses/216757> -->
 
**Time and Place:**  Thursdays 09:30am -- 12:20pm, Room TBD   
**Lab Hours:** TBD  
**Student Hours:** [Schedule an appointment](https://calendly.com/gustavo-diaz-nu/meetings)
...
- Participation
- Lab assignments (8 total, due Mondays 11:59 PM)
...
Your final paper will be marked as *outstanding*, *satisfactory*, *unsatisfactory*, or *failed*. You are also welcome to resubmit a final paper marked as unsatisfactory at any point, but that means I will not be able to update your grade until after the final grade report deadline. I encourage submitting an incomplete paper for a temporary grade over submitting nothing for an incomplete.
...
- 3/8 labs marked as unsatisfactory or failed: B-
- 4/8 labs marked as unsatisfactory or failed: C
...
## Week 3 (October 2): NO CLASS INSTRUCTOR CONFLICT

<!-- May schedule special TA section -->

## Week 4 (October 9): Random Variables
**Reading:**
