...
::: {.block fill="rgb(\"E4E0EE\")" inset="10pt" radius="10pt" width="100%"}
<!-- Remember double space for line skip -->
**Instructor:** Gustavo Diaz (<gustavo.diaz@northwestern.edu>)  
**Office Hours:** By appointment ([cal.com/gustavodiaz/](https://cal.com/gustavodiaz/))  
**Office:** 2001 Sheridan Rd, suite 3152

**Teaching Assistant:** Mikhail Turchenko (<mturchenko@u.northwestern.edu>)  
**Office Hours:** TBD  
**Office:** 2001 Sheridan Rd, suite XXXX

**Lecture:**  Tuesdays 9:30am -- 12:20pm, 2001 Sheridan Rd, suite 3111  
**Lab:** Thursdays  11:00 -- 11:50am, 2001 Sheridan Rd, suite 3111      
**GitHub Repository:** [github.com/gustavo-diaz/ps403](https://github.com/gustavo-diaz/ps403)  
**Canvas:** [canvas.northwestern.edu/courses/256213](https://canvas.northwestern.edu/courses/256213)
...
The goal of statistical inference is to use the data we have to learn about something for which we do not have data. Establishing that connection requires making assumptions. This course aims to introduce tools and develop skills to conduct statistical inference with as few assumptions as possible.
...
The rest of the syllabus refers to this book as AM. A digital copy is available through the library subscription at no additional cost. You can purchase a physical copy directly from the publisher, although it is usually cheaper on online storefronts. I advise purchasing a physical copy only if you see yourself referencing the book frequently after taking this course.

The book tends to err on the side of brevity and mathematical rigor. Much of our class discussion, assignments, and additional reading will involve untangling and applying the topics in AM. Additional readings should be available through university library subscriptions or distributed promptly. You can find URLs for additional readings in the Schedule section.
...
You can install R and RStudio on your personal computer, which is the preferred use case. You can use [this link](https://rcdsdocs.it.northwestern.edu/tutorials/r/r-installation.html) for installation instructions on Windows and MacOS. See [this link](https://levente.littvay.hu/chromebook/) for installation instructions on Chromebooks, which is a bit more involved.
...
You will submit a short correspondence paper as your final assignment. *Correspondence* is a new format adopted by the [*American Journal of Political Science*](https://onlinelibrary.wiley.com/journal/15405907) (AJPS) dedicated to scholarship that revisits the central empirical claims in previously published work. In the broader discipline, these are known as replication papers ([which is maybe a misnomer](https://jblevins.org/log/rep)).

The goal of the correspondence paper is to apply what you have learned this quarter to a topic of your interest by reproducing the analysis of a previously published article, reflecting on the way it was conducted, consider what could be done differently, and possibly improve upon it.

You should think of this as the first step toward writing a publishable article in your field. Since the AJPS has a dedicated track for this form of scholarship, you are required to choose a paper published in the journal in the last five years (2021-2026).
...
You are allowed to work with co-authors or alone as you see fit. I am also open to discussing a different kind of paper or a different target journal if you know what you want to do.
...
Final papers are due on Wednesday, December 9 at 9AM. You should submit your paper in PDF format through Canvas. Your paper should follow the format listed in the [AJPS manuscript guidelines](https://ajps.org/guidelines-for-manuscripts/), up to 4,000 words and focusing on the main point. You are also required to submit a link to a GitHub repository (or equivalent) including all the code used to reproduce your tables, figures, and calculations. You may also include less important details in an appendix to keep the paper concise. You can read more about the correspondence format here: <https://ajps.org/2026/03/05/new-ajps-correspondence-and-corrections-policies/>
...
You will get a default grade if you meet the baseline grading contract. It will go lower if you miss parts of the contract, it will go higher if you meet the baseline plus other criteria.
...
- Complete 6 out of 8 lab assignments with a satisfactory mark
...
- Receive a satisfactory mark in 8 out of 8 lab assignments
...
The use of generative artificial intelligence in this course is encouraged as long as it is used to amplify humans instead of replacing them. Any form of cheating, including improper use of content generated by artificial intelligence, constitutes a violation of Northwestern’s academic integrity policy. The instructor's general philosophy is that using LLMs for research, statistics, and coding hurts your learning, but can be helpful once you have a solid background.

Copilot is [Northwestern University’s supported artificial intelligence service](https://www.it.northwestern.edu/about/news-events/2024/microsoft-copilot-available-university-community.html). When using Copilot while actively logged in with a Northwestern account, data is stored securely in Northwestern’s Microsoft tenant, and Microsoft will not use it for product improvement or to train its AI models. 

{{< pagebreak >}}

# Schedule

## Week 1 (September 29): Preliminaries
**Reading:**

- AM Introduction

<!-- Include a conversation about using AI for coding -->

**Lab 0:** Project-oriented workflow in RStudio

## Week 2 (October 6): Probability theory
**Reading:**
...
## Week 3 (October 13): Random variables
...
**Lab 5:** Adjusting for covariates

## Week 7 (November 10): Parametric models
**Reading:**
...
**Lab 6:** Maximum likelihood estimation

## Week 8 (November 17): Missing data
**Reading:** 
...
**Lab 8:** Randomization inference and hypothesis testing
 
## Week 10 (December 1): Review/make-up class
