...
The rest of the syllabus refers to this book as AM. You can purchase a physical or digital copy directly from the publisher, although it's usually cheaper in storefronts like Amazon. A digital copy is available through the library subscription at no additional cost.
...
- 2/8 labs marked as failed: B-
- 3/8 labs marked as failed: C
- 4/8 or more labs marked as failed: F
...
We are leaving this week open to discuss topics that may be of interest to the group, I can think of three topics:

- Read about statistical methods for prediction (as opposed to inference)
